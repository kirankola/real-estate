...
contract Ownable {
    ...
    modifier onlyOwner {
        require(msg.sender == _owner, "contract owner only allowed");
        _;
    }
...
//  4) create 'whenNotPaused' & 'paused' modifier that throws in the appropriate situation
    ...
    modifier paused()
    {
        require(_paused, "Contract is already not paused.");
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    ...
    address tokenOwner = ownerOf(tokenId);   // get token owner address
   // address contractOwner=owner();          // get contract owner address       after checking erc721 protocol and openzepplen implemntation and consultned udacity mentor decided not to use it 
       
        
        // TODO require the given address to not be the owner of the tokenId
        
        require(to != tokenOwner, "To Address Cannot be the owner of the tokenId!");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
         require(msg.sender == tokenOwner || isApprovedForAll(tokenOwner, msg.sender), "only token owner  or approved operator allowed  .");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        // TODO revert if given tokenId already exists or given address is invalid
         ...
         require(to != address(0), " To address is invalid Address");
...
//      - make the base token uri: https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/
    contract RealEstateERC721Token is ERC721Metadata("Real Estate Exchange BND", "REsBND", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
